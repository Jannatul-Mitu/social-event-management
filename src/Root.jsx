...
import logoPng from './assets/logo-removebg.png';
                ...
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            {user && <li>
                                <NavLink to="/gallery" className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "text-[#79AC78] font-bold" : ""}>Gallery</NavLink>
                            </li>}
                            <div className="">
                                {user ? <li>
                    ...
                    <div className="flex items-center gap-3" data-aos="fade-right">
                        <Link to={"/"}><img className=' lg:w-[20%]' src={logo2} alt="" /></Link>
                    </div>
                </div>
            ...
            <div className="">
                ...
                <footer className="bg-white shadow dark:bg-gray-900">
                    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                        ...
                        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 Jannatul Ferdous Mitu All Rights Reserved.</span>
                    </div>
                </footer>
